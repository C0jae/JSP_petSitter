...
ALTER TABLE jcpdev.q_comment ADD CONSTRAINT q_comment_ibfk_2 FOREIGN KEY (q_idx) 
REFERENCES jcpdev.q_board(q_idx) ON DELETE CASCADE ON UPDATE RESTRICT;
...
INSERT INTO jcpdev.`member` (admin,name,id,password,nick,gender,birth,tel,m_addr,s_addr,`point`,p_auth,license,work_date,home) VALUES
	 ...
	 (0,'보옴','spring','11111111','봄','남자','2001-01-01','01011111111','서울 강남구 가로수길 5 (신사동)','101동 101호',25500,'지원','반려동물 종합관리사',20,'아파트'),
	 (0,'여름','summer','11111111','여름','여자','2002-02-02','01022222222','서울 강남구 테헤란로 146','102동 202호',125000,'지원','반려동물 관리사, 반려동물 종합관리사',20,'아파트'),
	 (0,'가을','autumn','11111111','가을','남자','2003-03-03','01033333333','서울 강남구 논현동 199-4','303호',165000,'지원','반려동물 관리사, 반려동물 종합관리사',0,'아파트'),
	 (0,'겨울','winter','11111111','겨울','여자','2004-01-01','01012345678','경기 화성시 새솔동 0','15-1',185000,'지원','반려동물관리 교육이수',10,'단독주택'),
	 ...
	 (4,'2021-11-01 13:32:34',11500),
	 (4,'2021-11-01 13:55:02',11500);
	 ...
	 (5,'강아지 돌봅니다~','강아지 좋아하고 맡겨주시면 후회하지 않으실겁니다~','2021-11-09','2021-11-22','[소형견, 대형견]','#아파트 #산책로 있어요','[대형견가능, 노견케어]','img43.jpg','충북 충주시 호암수청1로 13 (호암동, 우미린에듀시티)'),
	 (5,'안녕하세요!','❇️안락하 개. 재미있 개. 행복하 개.❇️ 별이 된 남동생 꼬맹이처럼 돌봐드릴게요!!🤗🙇‍♀️ 안녕하세요~ 지난 25년간 5마리의 댕댕이와 함께 한 펫플레닛 펫시터 김*은입니다:) 작년 15살의 나이로 암투병하다 무지개 다리를 건넌 울 착하고 똑똑한 꼬맹이, 암 선고 후 동반 출퇴근이 가능한 회사로 옮겨 1년간 항상 함께하며 행복한 시간을 보냈습니다ㅠ 꼬맹이처럼 24시간 가족같은 밀착 케어 약속드려요~😊 물론 노령견 케어도 자신있구요!! 무엇보다 저는 현재 반려견이 없어 예민하고 겁이 많은 아이들도 내집처럼 안락하게 지낼 수 있을 뿐 아니라, 사진처럼 30평이 넘는 집에 혼자 거주 중(어린아이/흡연자 없음)이라 아이의 생활환경이 너무 넓고 쾌적하답니다!! 정기적으로 오는 아이들도 넓은 거실에서 잘 뛰어놀고, 호기심 대마왕이라 안장 작은방들 심저 보조주방까지 구석구석 주책부리며 돌아다녀요ㅋㅋ 특히 2층이라 베란다로 바깥 구경하는걸 넘넘 좋아하드라구요ㅎ😆 산책은 주로 자차로 근처 잠원한강공원, 도산공원, 청담공원으로 가기 때문에 동네 한바퀴 도는 것과는 차원이 다르실꺼예요!!💁‍♀️ 저는 펫시터를 부업이 아닌 전업으로 하고 있어(반려동물관리사 자격증 과정 중) 훨씬 세심하고 꼼꼼한 케어 가능합니다~ 안심하고 믿고 맡겨주세요!!:) 💖','2021-11-08','2021-11-26','[소형견, 대형견]','#아파트 #산책로 있어요','[대형견가능, 노견케어]','images (4)1.jpg','충북 충주시 호암수청1로 13 (호암동, 우미린에듀시티)'),
	 (5,'강아지 맡겨만주세요!!!','❇️안락하 개. 재미있 개. 행복하 개.❇️ 별이 된 남동생 꼬맹이처럼 돌봐드릴게요!!🤗🙇‍♀️ 안녕하세요~ 지난 25년간 5마리의 댕댕이와 함께 한 펫플레닛 펫시터 김*은입니다:) 작년 15살의 나이로 암투병하다 무지개 다리를 건넌 울 착하고 똑똑한 꼬맹이, 암 선고 후 동반 출퇴근이 가능한 회사로 옮겨 1년간 항상 함께하며 행복한 시간을 보냈습니다ㅠ 꼬맹이처럼 24시간 가족같은 밀착 케어 약속드려요~😊 물론 노령견 케어도 자신있구요!! 무엇보다 저는 현재 반려견이 없어 예민하고 겁이 많은 아이들도 내집처럼 안락하게 지낼 수 있을 뿐 아니라, 사진처럼 30평이 넘는 집에 혼자 거주 중(어린아이/흡연자 없음)이라 아이의 생활환경이 너무 넓고 쾌적하답니다!! 정기적으로 오는 아이들도 넓은 거실에서 잘 뛰어놀고, 호기심 대마왕이라 안장 작은방들 심저 보조주방까지 구석구석 주책부리며 돌아다녀요ㅋㅋ 특히 2층이라 베란다로 바깥 구경하는걸 넘넘 좋아하드라구요ㅎ😆 산책은 주로 자차로 근처 잠원한강공원, 도산공원, 청담공원으로 가기 때문에 동네 한바퀴 도는 것과는 차원이 다르실꺼예요!!💁‍♀️ 저는 펫시터를 부업이 아닌 전업으로 하고 있어(반려동물관리사 자격증 과정 중) 훨씬 세심하고 꼼꼼한 케어 가능합니다~ 안심하고 믿고 맡겨주세요!!:) 💖','2021-11-04','2021-11-24','[소형견, 중형견]','#아파트 #산책로있어요','[픽업가능, 노견케어]','images (4)2.jpg','서울 강남구 테헤란로 146');
INSERT INTO jcpdev.ps_board (idx,title,content,ps_sdate,ps_fdate,p_size,comment,terms,g_fname,m_addr) VALUES
	 (5,'안녕하세요! 강아지 맡겨주세요~','❇️안락하 개. 재미있 개. 행복하 개.❇️ 별이 된 남동생 꼬맹이처럼 돌봐드릴게요!!🤗🙇‍♀️ 안녕하세요~ 지난 25년간 5마리의 댕댕이와 함께 한 펫플레닛 펫시터 김*은입니다:) 작년 15살의 나이로 암투병하다 무지개 다리를 건넌 울 착하고 똑똑한 꼬맹이, 암 선고 후 동반 출퇴근이 가능한 회사로 옮겨 1년간 항상 함께하며 행복한 시간을 보냈습니다ㅠ 꼬맹이처럼 24시간 가족같은 밀착 케어 약속드려요~😊 물론 노령견 케어도 자신있구요!! 무엇보다 저는 현재 반려견이 없어 예민하고 겁이 많은 아이들도 내집처럼 안락하게 지낼 수 있을 뿐 아니라, 사진처럼 30평이 넘는 집에 혼자 거주 중(어린아이/흡연자 없음)이라 아이의 생활환경이 너무 넓고 쾌적하답니다!! 정기적으로 오는 아이들도 넓은 거실에서 잘 뛰어놀고, 호기심 대마왕이라 안장 작은방들 심저 보조주방까지 구석구석 주책부리며 돌아다녀요ㅋㅋ 특히 2층이라 베란다로 바깥 구경하는걸 넘넘 좋아하드라구요ㅎ😆 산책은 주로 자차로 근처 잠원한강공원, 도산공원, 청담공원으로 가기 때문에 동네 한바퀴 도는 것과는 차원이 다르실꺼예요!!💁‍♀️ 저는 펫시터를 부업이 아닌 전업으로 하고 있어(반려동물관리사 자격증 과정 중) 훨씬 세심하고 꼼꼼한 케어 가능합니다~ 안심하고 믿고 맡겨주세요!!:) 💖','2021-11-03','2021-11-24','[소형견, 대형견]','#아파트 #산책로있어요','[대형견가능, 노견케어]','img22.jpg','서울 강남구 테헤란로 146'),
	 (5,'안심하고 맡겨주세요~!','❇️안락하 개. 재미있 개. 행복하 개.❇️ 별이 된 남동생 꼬맹이처럼 돌봐드릴게요!!🤗🙇‍♀️ 안녕하세요~ 지난 25년간 5마리의 댕댕이와 함께 한 펫플레닛 펫시터 김*은입니다:) 작년 15살의 나이로 암투병하다 무지개 다리를 건넌 울 착하고 똑똑한 꼬맹이, 암 선고 후 동반 출퇴근이 가능한 회사로 옮겨 1년간 항상 함께하며 행복한 시간을 보냈습니다ㅠ 꼬맹이처럼 24시간 가족같은 밀착 케어 약속드려요~😊 물론 노령견 케어도 자신있구요!! 무엇보다 저는 현재 반려견이 없어 예민하고 겁이 많은 아이들도 내집처럼 안락하게 지낼 수 있을 뿐 아니라, 사진처럼 30평이 넘는 집에 혼자 거주 중(어린아이/흡연자 없음)이라 아이의 생활환경이 너무 넓고 쾌적하답니다!! 정기적으로 오는 아이들도 넓은 거실에서 잘 뛰어놀고, 호기심 대마왕이라 안장 작은방들 심저 보조주방까지 구석구석 주책부리며 돌아다녀요ㅋㅋ 특히 2층이라 베란다로 바깥 구경하는걸 넘넘 좋아하드라구요ㅎ😆 산책은 주로 자차로 근처 잠원한강공원, 도산공원, 청담공원으로 가기 때문에 동네 한바퀴 도는 것과는 차원이 다르실꺼예요!!💁‍♀️ 저는 펫시터를 부업이 아닌 전업으로 하고 있어(반려동물관리사 자격증 과정 중) 훨씬 세심하고 꼼꼼한 케어 가능합니다~ 안심하고 믿고 맡겨주세요!!:) 💖','2021-11-03','2021-11-23','[소형견, 중형견]','#아파트 #산책로있어요','[픽업가능, 노견케어]','img53.jpg','서울 강남구 테헤란로 146');
	 ...
	 (4,'리트리버','도리','female',12.0,'2021-01-01','neu'),
	 (5,'리트리버','뭉치','male',16.0,'2021-01-01','neu'),
	 (5,'사모에드','우유','female',15.0,'2021-01-01','neu');
INSERT INTO jcpdev.pet (idx,pet,p_name,p_gender,p_weight,p_birth,p_neu) VALUES
	 (4,'말티즈','토리','male',4.0,'2021-01-01','neu');
	 ...
	 (4,7,126500,'2021-11-09','2021-11-10',NULL,'2021-11-01 13:32:34'),
	 (4,5,126500,'2021-11-15','2021-11-16',NULL,'2021-11-01 13:55:02');
	 ...
	 (8,'버즈','너무 좋아요','너무 잘 봐주셔서 감사드려요~ 사진도 찍어주고 일정시간마다 돌봄에 대해서 자세하게 작성해주시네요! 다음에도 기회가 된다면 또 부탁드릴게요 ^^

',NULL,NULL,'봄',5,'2021-10-28 13:20:58',1),
	 ...
	 (4,'봄','후기입니다','이사문제로 갑자기 맡기게 되었는데 저랑 있을때보다 더 편안해 보이는건 먼가요 ㅋ 심지어 밥도 저랑. 있을때보다 잘 먹더라구요~이사 준비 하느라 정신이 없었는데 픽업도 해주시고 잘 케어해주셔서 넘넘 감사 드려요♡',NULL,NULL,'가을',4,'2021-10-28 15:30:04',2),
	 ...
	 (9,'SG워너비','좋습니다!','요새 운동량이 적지않은데 살이 좀 올라서 통통해진 벤지 바로 알아보시고 산책 많이 시켜주셔서 정말 감동입니다😭 벤지가 그날 하루 어떻게 보냈는지는 픽업하자마자 딱 보이는데 이미 기분이 좋아질대로 좋아져버린 벤지를 보고 아주 흐뭇했습니다ㅋㅋㅋㅋㅋ 항상 감사해요❤️',NULL,NULL,'여름',3,'2021-10-28 15:59:30',1),
	 (8,'버즈','후기입니다~!','분리불안도 너무 심하고 겁도 많던애라 너무 불안했는데 첫날에도 너무너무 예뻐해주시고 잠도 제대로 못주무시고 계속 예뻐해주시는 덕분에 둘째날 셋째날 바로바로 적응하고 너무나도 편하게 자기집 마냥 벌러덩 자기도 하고 놀기도 잘 놀구 먹을 것도 잘 먹구 편하게 지내다가 온거같아용 너무너무 예뻐해주시고 사랑 듬뿍 주시고 사진이며 영상이며 계속 보내주시고 덕분에 편안하게 잘 놀다 온것같아요!ㅎㅎ 감사합니다!! 다음에 또 맡길일 생기면 무조건 여기💕💕💕',NULL,NULL,'SG워너비',5,'2021-10-28 16:01:40',2),
	 (4,'봄','후기','너무 만족합니다!',NULL,NULL,'여름',4,'2021-11-01 13:56:05',2);



	 INSERT INTO jcpdev.q_board (idx,nick,title,content,q_cnt,q_date,ip) VALUES
	 (5,'여름','펫시터 신청방법','펫시터 신청 어떻게 하나요?',7,'2021-10-27 23:27:47','196.0.0.1'),
	 (9,'SG워너비','안녕하세요','안녕하세요~',2,'2021-10-28 15:57:40','196.0.0.1'),
	 (5,'여름','결제 어떻게 하나요?','결제 어디서 해야하나요???',1,'2021-11-01 13:35:24','196.0.0.1'),
	 (4,'봄','안녕하세요','안녕하세요~!!!',2,'2021-11-01 13:57:01','196.0.0.1');
